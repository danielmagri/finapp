import 'package:flutter/material.dart' show Brightness, BuildContext, InheritedWidget, Key, State, StatefulWidget, ThemeMode, Widget;
...
class AppTheme extends StatefulWidget {
  ...
  const AppTheme({Key? key, required this.builder, this.themeChanged, required this.initialTheme}) : super(key: key);
...
class _AppThemeState extends State<AppTheme> {
  ...
  void initState() {
    ...
    widget.themeChanged?.call(theme);
    super.initState();
  }
